...
const Sidebar = ({ isOpen, toggleSidebar }) => {
    ...
    const sidebarWidth = 520 * (1 + (activeMenu ? 1 : 0) + (activeSubMenu ? 1 : 0));

    return (
        <div
            className={`fixed top-0 left-0 h-full bg-white z-50 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out overflow-y-scroll custom-scroll`}
                ...
                <div className="relative flex flex-col lg:flex-row px-5 lg:px-20 w-full gap-5 lg:gap-20">
                    ...
                    <div className="flex-grow basis-[500px] pr-4">
                        <nav className="flex flex-col gap-2 font-subHeading text-[14px] lg:text-[18px] leading-[150%] text-black">
                            {/* About Us */}
                            <Link to="/about-us">
                                <div onClick={toggleSidebar} className="flex items-center justify-between py-2 px-5 border-b border-black">
                                    <p>About Us</p>
                                </div>
                            </Link>
                                ...
                                <div className="lg:hidden flex flex-col gap-2 font-subHeading text-[14px] lg:text-[18px] leading-[150%] text-black pl-2">
                                    ...
                                    {activeSubMenu === "coatings" && (
                                        <div className="flex flex-col pl-5">
                                            <Link to="/productDet2/7377553227842" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>I-TINT</p>
                                                </div>
                                            </Link>
                                            <Link to="/productDet2/7377753079874" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Hydratint</p>
                                                </div>
                                            </Link>
                                            <Link to="/productDet2/7377753309250" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Smartint</p>
                                                </div>
                                            </Link>
                                            <Link to="/productDet2/7377753505858" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Tintol</p>
                                                </div>
                                            </Link>
                                            <Link to="/productDet2/7377753669698" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Blend</p>
                                                </div>
                                            </Link>
                                            <Link to="/productDet2/7377753866306" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Ultratint</p>
                                                </div>
                                            </Link>
                                            <Link to="/productDet2/7377754030146" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Walltint</p>
                                                </div>
                                            </Link>
                                            <Link to="/productDet2/7377754128450" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Aquaflexo</p>
                                                </div>
                                            </Link>
                                            <Link to="/productDet2/7377754488898" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Colorcomposit</p>
                                                </div>
                                            </Link>
                                    ...
                                    {activeSubMenu === "personalCare" && (
                                        <div className="flex flex-col pl-5">
                                            <Link to="/productDet/7376135127106" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Auratint</p>
                                                </div>
                                            </Link>
                                            <Link to="/productDet/7376147021890" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Auratone</p>
                                                </div>
                                            </Link>
                                            <Link to="/productDet/7376147120194" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Aurablush 6600</p>
                                                </div>
                                            </Link>
                                            ...
                                            <Link to="/productDet/7376147382338" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Aurablush 6670</p>
                                                </div>
                                            </Link>
                                            ...
                                            <Link to="/productDet/7376147546178" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>Aurablush 6610</p>
                                                </div>
                                            </Link>
                                    ...
                                    {activeSubMenu === "lifeSciences" && (
                                        <div className="flex flex-col pl-5">
                                            <Link to="/active-pharmaceutical-ingredients" onClick={toggleSidebar}>
                                                <div className="py-2 px-5 border-b border-black">
                                                    <p>APIs</p>
                                                </div>
                                            </Link>
