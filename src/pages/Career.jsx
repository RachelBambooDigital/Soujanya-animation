                ...
                <div className="w-full h-[700px] lg:h-[880px] bg-cover bg-center bg-white relative" >
                    ...
                    <div className='w-full flex h-full relative'>
                        ...
                        <div className='flex flex-col gap-6 text-black mb-20'>
                            <h1 className='font-heading leading-10 text-[28px] lg:text-[50px] lg:leading-[65px]'>Grow Your Career and Lead with Soujanya Group</h1>
                            <p className='text-[18px] font-subHeading leading-[26px] lg:w-[500px] text-[#667085]'>
                                We believe in giving a platform to young talented professionals and together shape the future. Join us and be a part of our extraordinary team. <br /> Have any queries? Contact us! We are here to help you.
                            </p>
                            <button className='bg-red text-white text-base font-subHeading h-[42px] w-[192px] rounded-lg' onClick={handleContactUs}>Contact Us</button>
                        </div>
