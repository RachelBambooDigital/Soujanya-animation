    ...
    return (
        <div className="">
            {/* <div className="w-full bg-cover bg-center bg-white relative" style={{ backgroundImage: `url("/pipe.png")` }}> */}
                <div className="w-full h-[1200px] lg:h-[880px] bg-cover bg-center  bg-white relative" style={{ backgroundImage: `url("/pipe.png")` }}>
                    ...
                    <div className='w-full flex h-full relative'>
                        ...
                        <div className='w-[200%] flex gap-5 lg:gap-8 justify-between lg:justify-end mb-5 lg:mb-10 px-3 lg:px-0'>
