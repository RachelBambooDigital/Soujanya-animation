...
const ProductListing2 = () => {
  ...
  return (
    <div className="scrollContainer w-full h-[1885px] overflow-hidden bg-no-repeat" ref={svgContainerRef}>
      <svg width="2436" height="4426" viewBox="250 0 2500 4500" fill="none" xmlns="http://www.w3.org/2000/svg">
