...
const ProductListing = () => {
  ...
  return (
    <div className="scrollContainer w-full h-[2425px] overflow-hidden bg-no-repeat" ref={svgContainerRef}>
      <svg width="1800" height="4026" viewBox="250 0 1900 5800" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className='h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[80dvh] w-full bg-cover bg-center relative bg-white'>
            ...
            <div className='absolute inset-3 flex flex-col gap-3 sm:gap-4 md:gap-5 lg:gap-6 justify-center text-white font-medium p-5 xl:p-10 -mb-40 sm:-mb-44 md:-mb-64 lg:-mb-16'>
              ...
              <h1 className='w-full md:w-[500px] lg:w-[650px] text-[40px] sm:text-[32px] md:text-[40px] lg:text-[56px] leading-[45px] sm:leading-10 md:leading-10 lg:leading-[65px] font-heading'>
                Home, Personal <br /> Care & Cosmetics
              </h1>
            </div>
          </div>
          ...
          <div className="bg-white">
            {categories.map((category, index) => (
              <div key={index}>
                ...
                <ProductListingCards products={category.products} />
              </div>
            ))}
          </div>
          <OurGlobalPresence />
