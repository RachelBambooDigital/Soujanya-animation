...
const ProductListing3 = () => {
  ...
  return (
    <div className="scrollContainer w-full h-[3195px] overflow-hidden bg-no-repeat" ref={svgContainerRef}>
      <svg width="2100" height="4026" viewBox="110 0 2436 5026" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="absolute w-full h-full top-[0] z-10 ">
        <div className='w-full bg-cover bg-center relative'>
          <div className='h-[50vh] sm:h-[50vh] md:h-[60vh] lg:h-[80dvh] w-full bg-cover bg-center relative bg-white'>
            <img 
