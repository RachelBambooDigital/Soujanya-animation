...
const LifeSciences = () => {
  ...
  return (
    <div className="scrollContainer w-full h-[4475px] overflow-hidden bg-no-repeat" ref={svgContainerRef}>
      <svg width="2436" height="5026" viewBox="250 0 1965 3600" fill="none" xmlns="http://www.w3.org/2000/svg">
