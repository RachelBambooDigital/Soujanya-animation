...
const ProductDetail2 = () => {
    ...
    // set
    return (
        <div className="scrollContainer w-full h-[2750px] overflow-hidden bg-no-repeat" ref={svgContainerRef}>
            <svg width="3600" height="4026" viewBox="100 0 4936 4750" fill="none" xmlns="http://www.w3.org/2000/svg">
